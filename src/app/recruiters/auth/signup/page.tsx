...
import { Eye, EyeOff, Mail, User, Lock, Building, ArrowLeft } from 'lucide-react';
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (result.error) {
                ...
                setTimeout(() => {
                    router.push('/recruiters/auth/signin');
                }, 2000);
            }
        } catch (err) {
        ...
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800 p-4">
            <div className="w-full max-w-md">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-gray-600 dark:text-gray-400 mt-2">Join as a Recruiter</p>
                </div>

                <Card>
                    <CardHeader className="space-y-1">
                        <CardTitle className="text-2xl font-bold text-center">Create Recruiter Account</CardTitle>
