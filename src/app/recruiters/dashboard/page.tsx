...
import { RecruiterOnboardingStatsCard } from '@/components/recruiter-onboarding';
        ...
        <ProtectedRoute requiredRole="recruiter">
            <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    ...
                    <div className="mb-8">
                        ...
                        <p className="text-gray-600 dark:text-gray-400 mt-2">
                            {stats && stats.active_jobs === 0
                                ? "Let's get you started with your first job posting."
                    ...
                    <div className="mb-8">
                        <div className="flex flex-wrap gap-4">
                            ...
                            >
                                ...
                                <span>{stats && stats.active_jobs === 0 ? 'Post Your First Job' : 'Post New Job'}</span>
                            </Button>
                            {stats && stats.active_jobs > 0 && (
                                <>
                    ...
                    {statsLoading ? (
                        <RecruiterStatsSkeleton />
                    ) : statsError || (stats && stats.active_jobs === 0) ? (
                        // Show onboarding experience for new recruiters
                        <RecruiterOnboardingStatsCard onCreateJob={() => setCreateJobModalOpen(true)} />
                    ) : (
                    ...
                    {/* Main Content Grid */}
                    {stats && stats.active_jobs === 0 ? (
                        // Show onboarding tips for new recruiters
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            <Card>
                                <CardHeader>
                                ...
                                <CardContent>
                                    <div className="space-y-4">
                                        <div className="p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                                            <h4 className="font-medium text-gray-900 dark:text-white mb-1">Active Jobs</h4>
                                            <p className="text-sm text-gray-600 dark:text-gray-400">Track your live job postings and application counts</p>
                                        </div>
                                        <div className="p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                                            <h4 className="font-medium text-gray-900 dark:text-white mb-1">Recent Activity</h4>
