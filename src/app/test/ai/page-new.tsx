...
export default function AIInterviewTestPage() {
    ...
    // SIMPLIFIED Function to save images to interview_artifacts at the end of interview
    ...
    const handleInterviewComplete = async (finalAssessment: FinalAssessment, conversation: any[]) => {
        ...
        // Wait 5 seconds for backend to create interview_artifacts record, then update
